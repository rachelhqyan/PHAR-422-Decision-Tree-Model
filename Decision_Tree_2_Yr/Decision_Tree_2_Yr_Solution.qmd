...
The expected cost under conventional management (T0) is `r scales::dollar(sum(exp_cost_T0_2), accuracy = 0.01)`.

The expected cost under treatment (T1) is `r scales::dollar(sum(exp_cost_T1_2), accuracy = 0.01)`.

**\*\*Question: What is the expected QALYs of patients in each strategy?**

The expected QALYs of patients under conventional management (T0) is `r round(sum(exp_qaly_T0_2), 3)`.

The expected QALYs of patients under treatment (T1) is `r round(sum(exp_qaly_T1_2), 3)`.

**\*\*Question: What is the 1-year-cost-effectiveness of the new treatment?**

The 1-year-cost-effectiveness of the new treatment (T1) is `r scales::dollar(icer_2, accuracy = 1)` per QALY gained.
