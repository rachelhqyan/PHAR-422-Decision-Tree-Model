...
2.2. Using the decision tree structure created, and the cost and probability data, populate the model to calculate the following: - What is the expected cost of treatment in each strategy - the new treatment ('T1') versus conventional management ('T0')? - What is the expected QALYs of patients in each strategy? - What is the 2 year cost effectiveness of the new treatment?

![Decision_Tree_2_Yr](../Figures/2_Yr_Decision_Tree.png)
...
p_HH2_T0 =   # probability the patient stays Healthy in year 2
p_HU2_T0 =   # probability the patient becomes Unhealthy in year 2
p_HD2_T0 =   # probability the patient Dies in year 2

# Unhealthy after Year 1
p_UU2_T0 =   # probability the patient stays Unhealthy in year 2
p_UD2_T0 =   # probability the patient Dies in year 2

# Death after Year 1
p_DD2_T0 =   # probability the patient stays Dead in Year 2
```
...
# Healthy after Year 1
p_HH_T0_2 =   # total probability the patient stays Healthy
p_HU_T0_2 =   # total probability the patient becomes Unhealthy
p_HD_T0_2 =   # total probability the patietn dies
  
# Unhealthy after Year 1
p_UU_T0_2 =   # total probability the patient stays Unhealthy
p_UD_T0_2 =   # total probability the patient Dies
  
# Death after Year 1
p_DD_T0_2 =   # probability the patient stays Dead
...
# Healthy after Year 1
cost_HH_T0_2 =   # cost of the patient if they stay Healthy
cost_HU_T0_2 =   # cost of the patient if they become Unhealthy
cost_HD_T0_2 =   # cost of the patient if they Die

# Unhealthy after Year 1
cost_UU_T0_2 =   # cost of the patient if they stay Unhealthy
cost_UD_T0_2 =   # cost of the patient if they Die

# Death after Year 1
cost_DD_T0_2 =   # cost of the patient if they stay Dead
...
# Healthy after Year 1
utility_HH_T0_2 =   # utility of the patient if they stay Healthy
utility_HU_T0_2 =   # utility of the patient if they become Unhealthy
utility_HD_T0_2 =   # utility of the patient if they Die

# Unhealthy after Year 1
utility_UU_T0_2 =   # utility of the patient if they stay Unhealthy
utility_UD_T0_2 =   # utility of the patient if they Die

# Death after Year 1
utility_DD_T0_2 =   # utility of the patient if they stay Dead
...
```{r}
# Year 1 pathway probabilities
p_H1_T1 <-   # probability the patient stays Healthy in year 1
p_U1_T1 <-   # probability the patient becomes Unhealthy in year 1
p_D1_T1 <-   # probability the patient Dies in year 1
...
# Healthy after Year 1
p_HH2_T1 <-   # probability the patient stays Healthy in year 2
p_HU2_T1 <-   # probability the patient becomes Unhealthy in year 2
p_HD2_T1 <-   # probability the patient Dies in year 2

# Unhealthy after Year 1
p_UU2_T1 <-   # probability the patient stays Unhealthy in year 2
p_UD2_T1 <-   # probability the patient Dies in year 2

# Dead after Year 1
p_DD2_T1 <-   # probability the patient stays Dead in year 2
```
...
# Healthy after Year 1
p_HH_T1_2 =   # total probability the patient stays Healthy
p_HU_T1_2 =   # total probability the patient become Unhealthy
p_HD_T1_2 =   # total probability the patient Dies

# Unhealthy after Year 1
p_UU_T1_2 =   # total probability the patient stays Unhealthy
p_UD_T1_2 =   # total probability the patient Dies

# Death after Year 1
p_DD_T1_2 =   # total probability the patient stays Dead
...
# Healthy after Year 1
cost_HH_T1_2 =   # cost of the patient if they stay Healthy
cost_HU_T1_2 =   # cost of the patient if they become Unhealthy
cost_HD_T1_2 =   # cost of the patient if they Die

# Unhealthy after Year 1
cost_UU_T1_2 =   # cost of the patient if they stay Unhealthy
cost_UD_T1_2 =   # cost of the patient if they Die

# Death after Year 1
cost_DD_T1_2 =   # cost of the patient if they stay Dead; only add cost for one year because they died in year 1
...
# Healthy after Year 1
utility_HH_T1_2 =   # utility of the patient if they stay Healthy
utility_HU_T1_2 =   # utility of the patient if they become Unhealthy
utility_HD_T1_2 =   # utility of the patient if they Die
  
# Unhealthy after Year 1
utility_UU_T1_2 =   # utility of the patient if they stay Unhealthy
utility_UD_T1_2 =   # utility of the patient if they Die
  
# Death after Year 1
utility_DD_T1_2 =   # utility of the patient if they stay Dead
...
```{r}
incremental_cost_2 <- sum( ) - sum( )
incremental_qaly_2 <- sum( ) - sum( )
icer_2 <- 
