...
cost_T0_1_table <- tribble(
  ~Outcome, ~Cost,
  "Healthy", scales::dollar( , accuracy = 0.01),
  "Unhealthy", scales::dollar( , accuracy = 0.01),
  "Death", scales::dollar( , accuracy = 0.01)
)
...
exp_cost_T0_1_table <- tribble(
  ...
  "Healthy",    scales::dollar(exp_cost_T0_1[""], accuracy = 1),
  "Unhealthy",  scales::dollar(exp_cost_T0_1[""], accuracy = 1),
  "Death",      scales::dollar(exp_cost_T0_1[""], accuracy = 1)
)
...
exp_cost_T1_1_table <- tribble(
  ~Outcome,    ~Expected_Cost,
  "Healthy",    scales::dollar(exp_cost_T1_1[""], accuracy = 1),
  "Unhealthy",  scales::dollar(exp_cost_T1_1[""], accuracy = 1),
  "Death",      scales::dollar(exp_cost_T1_1[""], accuracy = 1)
)
...
exp_cost_1yr <- tribble(
  ...
  "T0 (Conventional)", scales::dollar(sum(), accuracy = 0.01),
  "T1 (Treatment)", scales::dollar(sum(), accuracy = 0.01)
)
...
exp_qaly_T0_1_table <- tribble(
  ...
  "Healthy",    round(exp_qaly_T0_1[""], 3),
  "Unhealthy",  round(exp_qaly_T0_1[""], 3),
  "Death",      round(exp_qaly_T0_1[""], 3)
)
...
exp_qaly_T1_1_table <- tribble(
  ~Outcome,    ~Expected_QALY,
  "Healthy",    round(exp_qaly_T1_1[""], 3),
  "Unhealthy",  round(exp_qaly_T1_1[""], 3),
  "Death",      round(exp_qaly_T1_1[""], 3)
)
...
exp_qaly_1yr <- tribble(
  ...
  "T0 (Conventional)", round(sum(), 3),
  "T1 (Treatment)", round(sum(), 3)
)
...
icer_1yr <- tribble(
  ...
  scales::dollar( , accuracy = 1), round( , 3), scales::dollar( , accuracy = 1) 
)
